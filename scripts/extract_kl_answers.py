#!/usr/bin/env python3
"""국어 정답표 PDF에서 정답 데이터 추출 → data/kl_answers.json"""
...
PDF_PATH = BASE_DIR / "data/pdfs/korean_language/국어 정답표.pdf"
OUTPUT_PATH = BASE_DIR / "data/kl_answers.json"
...
# 벡터 전용 페이지 (텍스트 추출 불가) - 이미지로 직접 확인 후 하드코딩
HARDCODED_ANSWERS: dict[str, list[int]] = {
    "2020_1": [3, 4, 3, 3, 1, 3, 3, 1, 1, 1, 4, 4, 2, 2, 4, 2, 3, 3, 2, 2, 1, 2, 4, 1, 2],
}
