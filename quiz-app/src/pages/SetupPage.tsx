            ...
            {[
              {
                ...
                icon: (
                  <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
                    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 14c-.83 0-1.5-.67-1.5-1.5S9.17 14 10 14s1.5.67 1.5 1.5S10.83 17 10 17zm0-4c-.83 0-1.5-.67-1.5-1.5S9.17 10 10 10s1.5.67 1.5 1.5S10.83 13 10 13zm0-4c-.83 0-1.5-.67-1.5-1.5S9.17 6 10 6s1.5.67 1.5 1.5S10.83 9 10 9zm4 8c-.83 0-1.5-.67-1.5-1.5S13.17 14 14 14s1.5.67 1.5 1.5S14.83 17 14 17zm0-8c-.83 0-1.5-.67-1.5-1.5S13.17 6 14 6s1.5.67 1.5 1.5S14.83 9 14 9z" />
                  </svg>
                ),
              },
              {
