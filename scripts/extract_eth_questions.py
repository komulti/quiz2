#!/usr/bin/env python3
"""도덕 문제 PDF + eth_answers.json → data/questions/ethics.json"""
...
OUTPUT_PATH = BASE_DIR / "data/questions/ethics.json"
...
def main():
    ...
    for pdf_path in pdf_files:
        ...
        for q_num in range(1, 26):
            ...
            entry = {
                "id": f"eth_{exam_key}_{q_num:02d}",
                "year": int(year),
                "session": int(session),
                "number": q_num,
                "text": q_text,
                "image": f"images/ethics/{exam_key}_{q_num:02d}.png",
                "options": [
