#!/usr/bin/env python3
"""과학 문제 PDF + sci_answers.json → data/questions/science.json"""
...
OUTPUT_PATH = BASE_DIR / "data/questions/science.json"
...
def main():
    ...
    for pdf_path in pdf_files:
        ...
        for q_num in range(1, 26):
            ...
            entry = {
                "id": f"sci_{exam_key}_{q_num:02d}",
                "year": int(year),
                "session": int(session),
                "number": q_num,
                "text": q_text,
                "image": f"images/science/{exam_key}_{q_num:02d}.png",
                "options": [
