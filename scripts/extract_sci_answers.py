#!/usr/bin/env python3
"""과학 정답표 PDF → data/sci_answers.json"""
...
PDF_PATH = BASE_DIR / "data/pdfs/science/과학 정답표.pdf"
OUTPUT_PATH = BASE_DIR / "data/sci_answers.json"

CIRCLE_MAP = {"①": 1, "②": 2, "③": 3, "④": 4}
CUSTOM_CIRCLE_MAP = {"\u085a": 1, "\u085b": 2, "\u085c": 3, "\u085d": 4}

HARDCODED_ANSWERS: dict[str, list[int]] = {
    "2020_1": [2, 4, 4, 1, 4, 1, 1, 2, 2, 1, 2, 3, 3, 4, 3, 3, 2, 4, 3, 2, 1, 4, 1, 3, 1],
}
