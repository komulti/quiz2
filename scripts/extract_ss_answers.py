#!/usr/bin/env python3
"""사회 정답표 PDF → data/ss_answers.json"""
...
PDF_PATH = BASE_DIR / "data/pdfs/social_studies/사회 정답표.pdf"
OUTPUT_PATH = BASE_DIR / "data/ss_answers.json"
...
HARDCODED_ANSWERS: dict[str, list[int]] = {
    "2020_1": [1, 4, 2, 4, 2, 4, 1, 3, 2, 4, 3, 3, 2, 1, 3, 4, 1, 4, 2, 2, 1, 1, 1, 3, 3],
}
